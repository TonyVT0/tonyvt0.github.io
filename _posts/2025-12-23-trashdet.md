---
layout: post
title: ♻️ TrashDet - Iterative Neural Architecture Search for Efficient Waste Detection
subtitle: Bringing Trash Detection to TinyML
...
**Tran, T.**, & Hu, B. (2026, March). TrashDet: Iterative neural architecture search for efficient waste detection. Paper to be presented at the IEEE/CVF Winter Conference on Applications of Computer Vision (WACV) Workshops (WasteVision), Tucson, AZ.
