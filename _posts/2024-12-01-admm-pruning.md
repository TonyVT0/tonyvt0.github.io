...
![Training Objective and Validation Accuracy curves](/assets/img/admm-pruning/Figure1.png){: .mx-auto.d-block :}
...
| :--- | :--- | :--- | :--- |
| **MobileNetV2** | Base | 80.66 | 67.10 |
| | ADMM | 10.00 | **70.60** |
| **MobileNetV3-Small** | Base | 72.47 | 68.48 |
| | ADMM | 48.33 | 64.57 |
| **MobileNetV3-Large** | Base | 85.06 | 60.13 |
| | ADMM | 35.97 | 35.97 |

Notably, for **MobileNetV3-Large**, the baseline substantially outperformed ADMM. This suggests that the larger model size amplified the optimization challenge, causing ADMM to struggle with the increased architectural complexity.
...
![Weight Distribution of ADMM Method](/assets/img/admm-pruning/Figure3.png){: .mx-auto.d-block :}
